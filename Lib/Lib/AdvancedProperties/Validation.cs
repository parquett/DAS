// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Validation.cs" company="SecurityCRM">
//   Copyright ©  2020
// </copyright>
// <summary>
    ...
    public class Validation : PropertyItem
    {
        ...
        public string AlertMessage
        {
            get
            {
                ...
                {
                    return Tools.Utils.Translate.GetTranslatedValue(this.alertMessage, "FrontEnd", this.alertMessage.Replace("Admin_", string.Empty).Replace("_", " "));
                }
                return "";
            }
            set
