// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AdvancedProperty.cs" company="SecurityCRM">
//   Copyright ©  2020
// </copyright>
// <summary>
...
namespace Lib.AdvancedProperties
{
    ...
    public class AdvancedProperty
    {
        ...
        public string ControlViewSearch
        {
            get
            {
                if (Custom != null && Custom is LookUp && (((LookUp)Custom).SearchAsMulticheck))
                {
                    return "MultyCheckSearch";
                }
                if (Custom != null && Custom is LookUp && (((LookUp)Custom).SearchAsMultiSelect))
                {
                    return "MultiSelect";
                }
                switch (Common.EditTemplate)
