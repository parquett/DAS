// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Common.cs" company="SecurityCRM">
//   Copyright ©  2020
// </copyright>
// <summary>
    ...
    public class Common : PropertyItem
    {
        ...
        public string DisplayName
        {
            get
            {
                ...
                {
                    return global::Lib.Tools.Utils.Translate.GetTranslatedValue(this.displayName, "FrontEnd", this.displayName.Replace("Admin_", string.Empty).Replace("_", " "));
                }
                return "";
            }
            set
        ...
        public string PrintName
        {
            get
            {
                ...
                {
                    return global::Lib.Tools.Utils.Translate.GetTranslatedValue(this.printName, "FrontEnd", this.printName.Replace("Admin_", string.Empty).Replace("_", " "));
                }
                return DisplayName;
            }
            set
        ...
        public string PropertyDescription
        {
            get
            {
                ...
                {
                    return global::Lib.Tools.Utils.Translate.GetTranslatedValue(this._PropertyDescription, "FrontEnd", this._PropertyDescription.Replace("Admin_", string.Empty).Replace("_", " "));
                }
                return "";
            }
            set
