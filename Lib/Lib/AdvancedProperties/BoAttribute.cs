// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BoAttribute.cs" company="SecurityCRM">
//   Copyright ©  2020
// </copyright>
// <summary>
...
namespace Lib.AdvancedProperties
{
    ...
    public class BoAttribute : PropertyItem
    {
        ...
        public BoAttribute()
        {
            ...
            AllowCreate = true;
            AllowImport = true;
            ImportAccess = (int)SecurityCRM.ApiContracts.Enums.Permissions.SuperAdmin;
            DefaultSimpleSearch = "";
            Icon = "circle-o";
            RecordsPerPage = 10;
        }
        ...
        /// <summary>
        /// Gets or sets the NoLink.
        /// </summary>
        public bool NoLink { get; set; }

        /// <summary>
        /// Gets or sets the ActionOnClick.
        /// </summary>
        public bool ActionOnClick { get; set; }
