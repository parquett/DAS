...
namespace Lib.Infrastructure.DependencyManagement
{
    /// <summary>
    ...
    {
        public virtual void Configure(IEngine engine, ContainerManager containerManager, EventBroker broker, LibConfig configuration)
        {
            //other dependencies
            containerManager.AddComponentInstance<LibConfig>(configuration, "nop.configuration");
