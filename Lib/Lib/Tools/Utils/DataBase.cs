using lib;
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DataBase.cs" company="SecurityCRM">
//   Copyright ©  2020
// </copyright>
// <summary>
...
namespace Lib.Tools.Utils
{
    ...
    public class DataBase
    {
        ...
        public static bool HasColumn(IDataReader Reader, string ColumnName)
        {
            ...
            {
                if (row["ColumnName"].ToString().ToUpper() == ColumnName.ToUpper())
                    return true;
        ...
        {
            if (HasColumn(rdr, valueKey) && rdr[valueKey] != DBNull.Value)
            {
                return rdr[valueKey];
            }
