...
namespace Lib.Tools.Utils
{
    ...
    public class CacheManager
    {
      ...
      /*  public static void SetCachedItem(string cacheId, object value, string groupNames = MemcacheGroup.GroupAll, string subKey = "")
        ...
        //    else
        //    {
        //        cache.Add(cacheItem, item, null, System.DateTimeZone.Now.AddHours(23), Cache.NoSlidingExpiration, CacheItemPriority.Normal, new CacheItemRemovedCallback(ReportRemovedCallback));
        //    }
        //}
