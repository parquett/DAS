// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UtilityMail.cs" company="SecurityCRM">
//   Copyright ©  2020
// </copyright>
// <summary>
...
namespace Lib.Tools.Utils
{
    ...
    public class UtilityMail
    {
        ...
        {
            MailMessage mailMessage = CreateMessage(body, replacements, to, null, null, subject,true);
        ...
        /// The <see cref="bool"/>.
        /// </returns>
        public static bool SendMessage(string body, ListDictionary replacements, string to, string subject, bool htmlbody)
        {
            MailMessage mailMessage = CreateMessage(body, replacements, to, null, null, subject, htmlbody);
            return InternalSend(mailMessage, false);
        }
        ...
        /// </returns>
        private static MailMessage CreateMessage(string body, ListDictionary replacements, string to, string from, string cc, string subject, bool htmlbody)
        {
            ...
            //var mailMessage = md.CreateMailMessage(to, replacements, body);
            //return mailMessage;
