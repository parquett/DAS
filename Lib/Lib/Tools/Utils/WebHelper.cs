    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetThisPageUrl(bool includeQueryString, bool useSsl)
        {
            ...
            if (includeQueryString)
            {
                ...
                url = storeHost + _httpContext.Request.GetDisplayUrl();
            }
            else
            {
                if (_httpContext.Request.GetDisplayUrl() != null)
                {
                    url = _httpContext.Request.GetDisplayUrl();
                }
            }
        ...
        public virtual bool IsCurrentConnectionSecured()
        {
            ...
            if (_httpContext != null && _httpContext.Request != null)
            {
                useSsl = _httpContext.Request.Scheme.ToLower()=="https";
        ...
        public virtual string GetStoreLocation(bool useSsl)
        {
            ...
            if (_httpContext != null && _httpContext.Request != null)
                result = result + (string)AppDomain.CurrentDomain.GetData("ContentRootPath");
            if (!result.EndsWith("/"))
                result += "/";
        ...
        public virtual T Query<T>(string name)
        {
            string queryParam = null;
            if (_httpContext != null && _httpContext.Request.Query[name].Count >0)
                queryParam = _httpContext.Request.Query[name];
            /*
        ...
        public virtual bool IsSearchEngine(HttpContext context)
        {
            return false;
        ...
        public virtual bool IsRequestBeingRedirected
        {
            get
            {
                ...
                return false; // response.IsRequestBeingRedirected;   
            }
        }
