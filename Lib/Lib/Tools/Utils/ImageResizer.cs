...
namespace Lib.Tools.Utils
{
    ...
    {
        public static void ResizeImageAndRatio(string origFile, string newFile, int newWidth, int newHeight)
        {
            System.Drawing.Image initImage = System.Drawing.Image.FromFile(origFile);
