...
namespace GeneticLabweblib.Controllers
{

    using GeneticLabLib.BusinessObjects;
    ...
    public class SystemManagement : Weblib.Controllers.SystemManagement
    {
        ...
        public ActionResult EditItem(string BO, string Namespace, long Id)
        {
            ...
            if (item != null)
            {
                ...
                if (item.GetType() == typeof(GeneticLabLib.BusinessObjects.User))
                {
                    if (!((GeneticLabLib.BusinessObjects.User)item).HasAtLeastOnePermission(((GeneticLabLib.BusinessObjects.User)item).Role.Permission))
                    {
        ...
        public ActionResult Profile(string Id)
        {
            ...
            var user = new GeneticLabLib.BusinessObjects.User(UserId);
            user = (GeneticLabLib.BusinessObjects.User)user.PopulateOne((ItemBase)user);
